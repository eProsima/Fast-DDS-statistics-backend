...
The *eProsima Fast DDS Statistics Backend* keeps track of the alerts generated
in the DDS layout.
...
In addition to their own trigger conditions, all alerts will also trigger there are no entitites that match the alert's entity filter.
