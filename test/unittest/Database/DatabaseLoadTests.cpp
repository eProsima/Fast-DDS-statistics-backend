...
// Test the load of a database without any entity
...
// Test the load of a database with one entity of each kind
TEST(database, load_empty_entities_database)
{
    // Read JSON
...
// Test the load of a database with one entity of each kind and one data of each kind
TEST(database, load_simple_database)
{
    // Read JSON
...
// Test the load of a database with three entities of each kind and three datas of each kind
TEST(database, load_complex_database)
{
    // Read JSON
    ...
    ASSERT_EQ(dump[TOPIC_CONTAINER_TAG], loadedDump[TOPIC_CONTAINER_TAG]);
    // ASSERT_EQ(dump[PARTICIPANT_CONTAINER_TAG], loadedDump[PARTICIPANT_CONTAINER_TAG]);
    // ASSERT_EQ(dump[PARTICIPANT_CONTAINER_TAG]["15"][DATA_VALUE_DATA_TAG],
    //           loadedDump[PARTICIPANT_CONTAINER_TAG]["15"][DATA_VALUE_DATA_TAG]);
