...
TEST(database, dump_unlinked_database)
{
    ...
    dump[LOCATOR_CONTAINER_TAG][locator2_id][NAME_TAG] = std::string(LOCATOR_DEFAULT_NAME(1));
    dump[LOCATOR_CONTAINER_TAG][locator2_id][ALIAS_TAG] = std::string(LOCATOR_DEFAULT_NAME(1));
