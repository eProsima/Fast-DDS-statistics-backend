...
rtps::GUID_t writer_guid_;
    ...
    eprosima::fastdds::
rtps::ParticipantDiscoveryInfo build_participant_discovered_info(
            eprosima::fastdds::
rtps::ParticipantProxyData& data)
    {
...
rtps::ParticipantDiscoveryInfo(data);
    }
