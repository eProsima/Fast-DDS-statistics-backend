...
TEST_F(statistics_participant_listener_tests, new_participant_discovered)
{
        ...
        EXPECT_CALL(database, update_participant_in_graph(EntityId(0),EntityId(13),EntityId(14),EntityId(15),EntityId(10))).Times(1).WillOnce(Return(true));
        ...
        *eprosima::statistics_backend::details::StatisticsBackendData::get_instance(),
        ...
        EXPECT_CALL(database, update_endpoint_in_graph(EntityId(0),EntityId(10),EntityId(11),EntityId(12))).Times(1).WillOnce(Return(true));
        EXPECT_CALL(*eprosima::statistics_backend::details::StatisticsBackendData::get_instance(), on_domain_graph_update(EntityId(0))).Times(2);
...
TEST_F(statistics_participant_listener_tests, new_participant_discovered_not_first)
{
        ...
        EXPECT_CALL(database,
                ...
                .WillRepeatedly(Return(std::vector<std::pair<EntityId, EntityId>>(1, std::make_pair(EntityId(0), EntityId(13)))));
        ...
        EXPECT_CALL(database,
                ...
                .WillRepeatedly(Return(std::vector<std::pair<EntityId, EntityId>>(1, std::make_pair(EntityId(0), EntityId(14)))));
        ...
        EXPECT_CALL(database,
                get_entities_by_name(EntityKind::PROCESS, process_name_)).Times(AnyNumber())
                .WillRepeatedly(Return(std::vector<std::pair<EntityId, EntityId>>(1, std::make_pair(EntityId(0), EntityId(15)))));
        ...
        // Expectation: Modify graph and notify user (twice, also from participant update)
        EXPECT_CALL(database, update_endpoint_in_graph(EntityId(0),EntityId(10),EntityId(6),EntityId(12))).Times(1).WillOnce(Return(true));
        EXPECT_CALL(*eprosima::statistics_backend::details::StatisticsBackendData::get_instance(), on_domain_graph_update(EntityId(0))).Times(2);
...
TEST_F(statistics_participant_listener_tests, new_participant_discovered_participant_already_exists)
{
        ...
        // Expectation: Modify graph
        EXPECT_CALL(database, update_participant_in_graph(EntityId(0),EntityId(13),EntityId(14),EntityId(15),EntityId(5))).Times(1).WillOnce(Return(true));
        ...
        // Expectation: Modify graph and notify user
        EXPECT_CALL(database, update_endpoint_in_graph(EntityId(0),EntityId(5),EntityId(6),EntityId(7))).Times(1).WillOnce(Return(false));
...
TEST_F(statistics_participant_listener_tests, new_participant_undiscovered_participant_already_exists)
{
        ...
        // Expectation: Modify graph and notify user
        EXPECT_CALL(database, update_participant_in_graph(EntityId(0),EntityId(13),EntityId(14),EntityId(15),EntityId(1))).Times(2)
        .WillOnce(Return(true))
        .WillOnce(Return(false));

        EXPECT_CALL(*eprosima::statistics_backend::details::StatisticsBackendData::get_instance(), on_domain_graph_update(EntityId(0))).Times(1);
...
TEST_F(statistics_participant_listener_tests, new_reader_discovered)
{
        ...
        // Expectation: Modify graph and notify user
        EXPECT_CALL(database, update_endpoint_in_graph(EntityId(0),EntityId(1),EntityId(2),EntityId(10))).Times(1).WillOnce(Return(true));
        EXPECT_CALL(*eprosima::statistics_backend::details::StatisticsBackendData::get_instance(), on_domain_graph_update(EntityId(0))).Times(1);
...
TEST_F(statistics_participant_listener_tests, new_reader_no_topic)
{
        ...
        // Expectation: Modify graph and notify user (twice, also from participant update)
        EXPECT_CALL(database, update_endpoint_in_graph(EntityId(0),EntityId(1),EntityId(10),EntityId(11))).Times(1).WillOnce(Return(true));
        EXPECT_CALL(*eprosima::statistics_backend::details::StatisticsBackendData::get_instance(), on_domain_graph_update(EntityId(0))).Times(1);
...
TEST_F(statistics_participant_listener_tests, new_reader_several_locators)
{
        ...
        // Expectation: Modify graph and notify user (twice, also from participant update)
        EXPECT_CALL(database, update_endpoint_in_graph(EntityId(0),EntityId(1),EntityId(2),EntityId(11))).Times(1).WillOnce(Return(true));
        EXPECT_CALL(*eprosima::statistics_backend::details::StatisticsBackendData::get_instance(), on_domain_graph_update(EntityId(0))).Times(1);
...
TEST_F(statistics_participant_listener_tests, new_reader_discovered_reader_already_exists)
{
        ...
        // Expectation: Modify graph and notify user (twice, also from participant update)
        EXPECT_CALL(database, update_endpoint_in_graph(EntityId(0),EntityId(1),EntityId(2),EntityId(10))).Times(1).WillOnce(Return(false));
