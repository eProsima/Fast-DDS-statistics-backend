...
rtps::WriterDiscoveryInfo::REMOVED_WRITER;
    ...
    // Finish building the discovered writer info
    eprosima::fastdds::
rtps::WriterDiscoveryInfo discover_info(data);
    discover_info.status = eprosima::fastdds::
...
rtps::ReaderDiscoveryInfo::REMOVED_READER;
    ...
    // Finish building the discovered writer info
    eprosima::fastdds::
rtps::ReaderDiscoveryInfo discover_info(data);
    discover_info.status = eprosima::fastdds::
...
rtps::ReaderDiscoveryInfo::REMOVED_READER;
    ...
    // Finish building the discovered writer info
    eprosima::fastdds::
rtps::WriterDiscoveryInfo writer_discover_info(writer_data);
    writer_discover_info.status = eprosima::fastdds::
rtps::WriterDiscoveryInfo::DISCOVERED_WRITER;

    // Finish building the discovered reader info
    eprosima::fastdds::
rtps::ReaderDiscoveryInfo reader_discover_info(reader_data);
    reader_discover_info.status = eprosima::fastdds::
rtps::ReaderDiscoveryInfo::DISCOVERED_READER;
