...
#ifndef FASTDDS_STATISTICS_BACKEND_SRC_CPP_TYPES__DATA_CONTAINER_HPP
#define FASTDDS_STATISTICS_BACKEND_SRC_CPP_TYPES__DATA_CONTAINER_HPP
...
class DataContainer : public std::list<T>
{
    ...
    static_assert(std::is_base_of<database::StatisticsSample, T>::value || std::is_base_of<MonitorServiceSample,
            T>::value,
...
#endif //FASTDDS_STATISTICS_BACKEND_SRC_CPP_TYPES__DATA_CONTAINER_HPP
