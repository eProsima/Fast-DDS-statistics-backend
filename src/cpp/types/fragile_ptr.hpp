...
#ifndef FASTDDS_STATISTICS_BACKEND_SRC_CPP_TYPES__FRAGILE_PTR_HPP
#define FASTDDS_STATISTICS_BACKEND_SRC_CPP_TYPES__FRAGILE_PTR_HPP
...
#endif //FASTDDS_STATISTICS_BACKEND_SRC_CPP_TYPES__FRAGILE_PTR_HPP
