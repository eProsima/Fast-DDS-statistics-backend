...
#define FASTDDS_STATISTICS_BACKEND_EXAMPLES_CPP_ROS2PROMETHEUS__ARG_CONFIGURATION_H
...
#endif /* FASTDDS_STATISTICS_BACKEND_EXAMPLES_CPP_ROS2PROMETHEUS_ARG_CONFIGURATION_H */
